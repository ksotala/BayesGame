...
public class DetNOTAnd {
	...
	public static Image paintPercentage(double percentage, Color gridColor,
		...
		if (p1true_p2true){
			NodePainter.twoBoxPainter(g, gridColor, gridColor, falseColor, 1,                      size_y / 2, box_size, size_y / 2, false);
		} else {
			NodePainter.twoBoxPainter(g, whiteColor, whiteColor, whiteColor, 1,                      size_y / 2, box_size, size_y / 2, false);
		}
		
		if (p1false_p2false){
			NodePainter.twoBoxPainter(g, falseColor, falseColor, gridColor, (size_x - box_size -2), size_y / 2, box_size, size_y / 2, false);
		} else {
