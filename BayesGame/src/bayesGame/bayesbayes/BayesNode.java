...
public class BayesNode {
	...
	private String createCPTDescription(Object[] scope) {
		if (scope.length == 1){
			return "'" + this.type + "' is a prior variable. The truth values of any of its child variables are derived from it, as well as from any other parent variables.";
		} else {
			return "'" + this.type + "' is a conditional probability variable of type <b>custom distribution.";			
		}
	}
