...
public class DeterministicOR implements NodeCPD {
	...
	public BayesNode getNode(BayesNode orBayesNode, Object[] parents) {
        ...
        String description = "'" + orBayesNode.type + "' is a conditional probability variable of type deterministic";
        String description2;
        String typename;
        
        if (parents.length > 1){
        	description2 = " or. It is true of any of its parent variables are true.";
        	typename = "DetOR";
        } else {
